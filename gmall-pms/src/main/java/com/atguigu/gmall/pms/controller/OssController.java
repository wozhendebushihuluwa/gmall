...
public class OssController {
    ...
    public Resp<Object> policy(){
        ...
        String accessId = "LTAI4FfHvUTAoyTnJednAvkU"; // 请填写您的AccessKeyId。
        String accessKey = "fnIBbOfInMjKSszohBe6RBdEJJf6CH"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gmall-zhx"; // 请填写您的 bucketname 。
