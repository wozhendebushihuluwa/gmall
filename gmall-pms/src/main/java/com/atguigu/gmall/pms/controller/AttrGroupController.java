...
public class AttrGroupController {
    ...
    public Resp<GroupVo> queryGroupVoByCid(@PathVariable("gid")Long gid){
        GroupVo groupVo= this.attrGroupService.queryGroupVoByCid(gid);
       return Resp.ok(groupVo);
    }

    @GetMapping("{catId}")
    public Resp<PageVo> queryGroupByCidPage(QueryCondition queryCondition,@PathVariable("catId")Long catId){
